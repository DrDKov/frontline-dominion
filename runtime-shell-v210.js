...
(() => {
  ...
  const BUILD = 210;
  if (globalThis.__FD_RUNTIME_SHELL_210__) return;

  const root = document.documentElement;
  root.dataset.fdBuild = String(BUILD);
  root.dataset.fdVersion = VERSION;

  const boot = globalThis.__FD_BOOT_210__;
  const state = {
    installed: false,
    launching: false,
    launchMode: null,
  ...
  const showLaunchError = (text) => {
    ...
    console.error('[FD210] Launch error:', state.lastError);
  ...
  const safeSave190 = (reason = 'periodic') => {
    ...
    try {
      ...
      console.info('[FD210] Checkpoint saved:', reason);
      return true;
    } catch (error) {
      if (parseSave190(previous, keys.current)) storageSet190(api, keys.current, previous);
      console.warn('[FD210] Checkpoint save failed:', reason, error);
      return false;
    }
  };
  ...
  const finishSuccessfulLaunch = () => {
    ...
    boot?.stop?.();
    root.classList.remove('fd-loading210', 'fd-ready210');
    root.classList.add('fd-running210');
    state.launching = false;
    const mode = state.launchMode;
    state.launchMode = null;
    configureAutosave190();
    console.info(
      '[FD210] Stable game observed after launch',
  ...
  const launchNewGame = (event) => {
    ...
    console.info('[FD210] Starting new game', options);
    try {
      api.startGame(options);
      verifyLaunch();
    } catch (error) {
      console.error('[FD210] startGame threw', error);
  ...
  const launchSavedGame = (event) => {
    ...
    console.info('[FD210] Starting saved game from', candidate.key);
    try {
      api.startGame({
      ...
      console.error('[FD210] saved start threw', error);
  ...
  const install = () => {
    ...
    console.info('[FD210] Canonical launch/save owner ready', {
  ...
  globalThis.__FD_RUNTIME_SHELL_210__ = {
    version: VERSION,
    build: BUILD,
    state,
    install,
...
globalThis.__FD_RUNTIME_SHELL_205__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_BOOT_205__ ||= globalThis.__FD_BOOT_210__;

globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_210__;

globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_210__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_210__;

globalThis.__FD_RUNTIME_SHELL_208__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_210__; globalThis.__FD_BOOT_208__ ||= globalThis.__FD_BOOT_210__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_210__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_210__;
