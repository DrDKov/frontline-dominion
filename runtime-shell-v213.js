...
(() => {
  ...
  const BUILD = 213;
  if (globalThis.__FD_RUNTIME_SHELL_213__) return;
  ...
  const showLaunchError = (text) => {
    ...
    console.error('[FD213] Launch error:', state.lastError);
  ...
  const safeSave190 = (reason = 'periodic') => {
    ...
    try {
      ...
      console.info('[FD213] Checkpoint saved:', reason);
      return true;
    } catch (error) {
      if (parseSave190(previous, keys.current)) storageSet190(api, keys.current, previous);
      console.warn('[FD213] Checkpoint save failed:', reason, error);
      return false;
    }
  };
  ...
  const finishSuccessfulLaunch = () => {
    ...
    boot?.stop?.();
    root.classList.remove('fd-loading213', 'fd-ready213');
    root.classList.add('fd-running213');
    state.launching = false;
    const mode = state.launchMode;
    state.launchMode = null;
    configureAutosave190();
    console.info(
      '[FD213] Stable game observed after launch',
  ...
  const launchNewGame = (event) => {
    ...
    console.info('[FD213] Starting new game', options);
    try {
      api.startGame(options);
      verifyLaunch();
    } catch (error) {
      console.error('[FD213] startGame threw', error);
  ...
  const launchSavedGame = (event) => {
    ...
    console.info('[FD213] Starting saved game from', candidate.key);
    try {
      api.startGame({
      ...
      console.error('[FD213] saved start threw', error);
  ...
  const launchSavedPayload213 = (raw, event = null) => {
    event?.preventDefault?.();
    event?.stopImmediatePropagation?.();
    ...
    console.info('[FD213] Starting saved game directly from slot payload');
    try {
      api.startGame({
        loadData: candidate.data,
        faction: candidate.data.teams?.player?.faction || 'vanguard',
      ...
      console.error('[FD213] direct saved start threw', error);
  ...
  const install = () => {
    ...
    console.info('[FD213] Canonical launch/save owner ready', {
  ...
  globalThis.__FD_RUNTIME_SHELL_213__ = {
    version: VERSION,
    build: BUILD,
    state,
    install,
    launchNewGame,
    launchSavedGame,
    launchSavedPayload: launchSavedPayload213,
    findSavedGame: () => findSavedGame190(debug(), false),
    saveNow: safeSave190,
  };
})();

globalThis.__FD_RUNTIME_SHELL_205__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_205__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_208__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_208__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_209__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_208__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_209__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_208__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_210__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_209__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_210__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_209__ ||= globalThis.__FD_BOOT_213__;

globalThis.__FD_RUNTIME_SHELL_211__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_RUNTIME_SHELL_210__ ||= globalThis.__FD_RUNTIME_SHELL_213__; globalThis.__FD_BOOT_211__ ||= globalThis.__FD_BOOT_213__; globalThis.__FD_BOOT_210__ ||= globalThis.__FD_BOOT_213__;
