...
(() => {
  ...
  const BUILD = 214;
  if (globalThis.__FD_RUNTIME_SHELL_214__) return;

  const root = document.documentElement;
  root.dataset.fdBuild = String(BUILD);
  root.dataset.fdVersion = VERSION;

  const boot = globalThis.__FD_BOOT_214__;
  const state = {
    installed: false,
    launching: false,
    launchMode: null,
  ...
  const showLaunchError = (text) => {
    ...
    console.error('[FD214] Launch error:', state.lastError);
  ...
  const safeSave190 = (reason = 'periodic') => {
    ...
    try {
      ...
      console.info('[FD214] Checkpoint saved:', reason);
      return true;
    } catch (error) {
      if (parseSave190(previous, keys.current)) storageSet190(api, keys.current, previous);
      console.warn('[FD214] Checkpoint save failed:', reason, error);
      return false;
    }
  };
  ...
  const finishSuccessfulLaunch = () => {
    ...
    boot?.stop?.();
    root.classList.remove('fd-loading214', 'fd-ready214');
    root.classList.add('fd-running214');
    state.launching = false;
    const mode = state.launchMode;
    state.launchMode = null;
    configureAutosave190();
    console.info(
      '[FD214] Stable game observed after launch',
  ...
  const launchNewGame = (event) => {
    ...
    console.info('[FD214] Starting new game', options);
    try {
      api.startGame(options);
      verifyLaunch();
    } catch (error) {
      console.error('[FD214] startGame threw', error);
  ...
  const launchSavedGame = (event) => {
    ...
    console.info('[FD214] Starting saved game from', candidate.key);
    try {
      api.startGame({
      ...
      console.error('[FD214] saved start threw', error);
  ...
  const launchSavedPayload214 = (raw, event = null) => {
    event?.preventDefault?.();
    event?.stopImmediatePropagation?.();
    ...
    console.info('[FD214] Starting saved game directly from slot payload');
    try {
      api.startGame({
        loadData: candidate.data,
        faction: candidate.data.teams?.player?.faction || 'vanguard',
      ...
      console.error('[FD214] direct saved start threw', error);
  ...
  const install = () => {
    ...
    console.info('[FD214] Canonical launch/save owner ready', {
  ...
  globalThis.__FD_RUNTIME_SHELL_214__ = {
    version: VERSION,
    build: BUILD,
    state,
    install,
    launchNewGame,
    launchSavedGame,
    launchSavedPayload: launchSavedPayload214,
    findSavedGame: () => findSavedGame190(debug(), false),
    saveNow: safeSave190,
  };
})();

globalThis.__FD_RUNTIME_SHELL_205__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_205__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_208__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_207__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_206__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_208__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_207__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_206__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_209__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_208__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_209__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_208__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_210__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_209__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_210__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_209__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_211__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_210__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_211__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_210__ ||= globalThis.__FD_BOOT_214__;

globalThis.__FD_RUNTIME_SHELL_212__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_211__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_RUNTIME_SHELL_210__ ||= globalThis.__FD_RUNTIME_SHELL_214__; globalThis.__FD_BOOT_212__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_211__ ||= globalThis.__FD_BOOT_214__; globalThis.__FD_BOOT_210__ ||= globalThis.__FD_BOOT_214__;
