...
(() => {
  ...
  if (globalThis.__FD_RUNTIME_UI_186__) return;
  globalThis.__FD_RUNTIME_UI_186__ = { version: VERSION, build: BUILD };
  ...
  function captureInfo(game) {
    ...
    return {
      ...
      progress: Number(source.captureProgress) || 0,
    };
  }
  ...
  function install() {
    ...
    if (!Game?.prototype || Game.prototype.__fdRuntimeUi186Installed) return false;
    const original = Game.prototype.updateUI;
    if (typeof original !== 'function') return false;
    Object.defineProperty(Game.prototype, '__fdRuntimeUi186Installed', { value: true, configurable: true });
    Game.prototype.updateUI = function runtimeUi186Update(...args) {
