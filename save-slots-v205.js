...
(() => {
  ...
  if (root.__FD_SAVE_SLOTS_205__) return;
  ...
  function updateLoadAvailability() {
    ...
    root.__FD_BOOT_205__?.setLoadAvailable?.(available);
  }

  async function migrateLegacy() {
    const shell = root.__FD_RUNTIME_SHELL_205__;
  ...
  root.addEventListener('fd:authoritative-save205', exactSaveFromEvent);
