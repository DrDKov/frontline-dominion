...
(() => {
  ...
  if (root.__FD_SAVE_SLOTS_206__) return;
  ...
  function updateLoadAvailability() {
    ...
    root.__FD_BOOT_206__?.setLoadAvailable?.(available);
  }

  async function migrateLegacy() {
    const shell = root.__FD_RUNTIME_SHELL_206__;
  ...
  root.addEventListener('fd:authoritative-save206', exactSaveFromEvent);
