...
(() => {
  ...
  if (root.__FD_SAVE_SLOTS_207__) return;
  ...
  function updateLoadAvailability() {
    ...
    root.__FD_BOOT_207__?.setLoadAvailable?.(available);
  }

  async function migrateLegacy() {
    const shell = root.__FD_RUNTIME_SHELL_207__;
  ...
  root.addEventListener('fd:authoritative-save207', exactSaveFromEvent);
...
globalThis.__FD_SAVE_SLOTS_205__ ||= globalThis.__FD_SAVE_SLOTS_207__;
