...
old="const d=game.getEntity?.(s.destinationNodeId);return urgent ? demandTotal214(d)<900 : demandTotal214(d)<160;"
new="const d=game.getEntity?.(s.destinationNodeId);return urgent ? true : demandTotal214(d)<160;"
