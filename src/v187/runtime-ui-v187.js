...
(() => {
  ...
  if (globalThis.__FD_RUNTIME_UI_187__) return;
  globalThis.__FD_RUNTIME_UI_187__ = { version: VERSION, build: BUILD };
  ...
  function install() {
    ...
    if (!Game?.prototype || Game.prototype.__fdRuntimeUi187Installed) return false;
    const original = Game.prototype.updateUI;
    if (typeof original !== 'function') return false;
    Object.defineProperty(Game.prototype, '__fdRuntimeUi187Installed', { value: true, configurable: true });
    Game.prototype.updateUI = function runtimeUi187Update(...args) {
